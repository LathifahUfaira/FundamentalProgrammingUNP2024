...
int main() {
    ...
    FILE *inputFile = fopen("C:\\Users\\YAFIKAR\\Downloads\\FUNDAMENTAL LATHIFAH UFAIRA\\input.txt", "r");
    if (inputFile == NULL) {
    ...
    FILE *outputFile = fopen("C:\\Users\\YAFIKAR\\Downloads\\FUNDAMENTAL LATHIFAH UFAIRA\\latoutput.txt", "w");
    if (outputFile == NULL) {
